...
namespace EmployeeManagement.Controllers
{
    public class ErrorController : Controller
    {
        ...
        {
            var exceptioDetails = HttpContext.Features.Get<IExceptionHandlerPathFeature>();
            //ViewBag.ExceptionPath = exceptioDetails.Path;
            //ViewBag.ExceptionMessage = exceptioDetails.Error.Message;
            //ViewBag.StackTrace = exceptioDetails.Error.StackTrace;
            logger.LogError($"The path {exceptioDetails.Path} threw an exception " +
